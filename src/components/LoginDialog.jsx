...
const LoginDialog = ({ open, onClose }) => {
  ...
  const handleRegister = () => {
    navigate("/EmailRegistration", { state: { from: location } });
  };
  const handleAsk = () => {
    navigate("/AskUs", { state: { from: location } });
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-[400px] p-8 animate-fadeIn">
        ...
        <div className="flex justify-center space-x-4 mt-5">
          <div
        className="flex gap-2 px-5 py-2 bg-gray-200 text-sm text-gray-800 font-medium rounded-lg shadow hover:bg-gray-300 transition"
             onClick={handleAsk}
          >
            <img
              src={icon1}
